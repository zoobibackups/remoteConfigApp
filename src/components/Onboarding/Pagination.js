import {View, StatusBar, I18nManager, Platform, StyleSheet} from 'react-native';
import PropTypes from 'prop-types';
import React from 'react';

import Dots from './Dots';
import {wp} from '../../constants/scaling';
import NativeAddSearchEmpty from '../AdView';
...
const Pagination = ({
  ...
  return (
    <View style={{height: bottomBarHeight}}>
      ...
      <NativeAddSearchEmpty media={true} myindex={currentPage} />
    </View>
  );
};
